...
if is_load_fresh
    ...
    for SUBJECT = 1:number_of_subjects
        ...
        data{SUBJECT} = load( [ IN STR2.SUBJECT '.epoch.' num2str(SRATE_EEG) '.mat' ] );
...
saveas(h, [OUT 'bar.png'], 'png')


stop_time = toc(start_time); disp(stop_time/60)